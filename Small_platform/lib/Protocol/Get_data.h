...
enum Symbol{
    ...
    RFID_MAX = 5,           //Максмальное число бит полезных данных в принимаемом с МК пакете для RFID-меток
    ...
    SERIAL_RFID = 3,        //Количество бит, отведенных под служебные поля для RFID-меток
};
enum ID_CAN{
    ...
    ID_RFID = 15,           //CAN-ID для RFID-меток
};
/*
